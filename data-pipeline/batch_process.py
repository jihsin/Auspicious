...
MAIN_STATIONS = [
    ...
    ("466940", "基隆", 1991),
    ("467490", "臺中", 1991),
    ("467440", "高雄", 1991),  # 修正: 467440 是舊站，467441 是新站
    ("467350", "澎湖", 1991),
    ("467480", "嘉義", 1991),
    ("466990", "花蓮", 1991),
    ("467660", "臺東", 1991),
    ...
    ("467550", "玉山", 1991),
    ("467410", "臺南", 1991),
    # === Phase 2: 新增站點（有 1991 年以來的歷史資料）===
    ("466900", "淡水", 1991),      # 新北市
    ("467080", "宜蘭", 1991),      # 宜蘭縣
    ("467540", "大武", 1991),      # 屏東縣
    ("467610", "成功", 1991),      # 臺東縣（東海岸）
    ("467620", "蘭嶼", 1991),      # 蘭嶼（離島）
    # === Phase 2.5: 更多站點 ===
    ("466850", "五分山", 1991),    # 新北市瑞芳
    ("466910", "鞍部", 1991),      # 臺北市陽明山
    ("466930", "竹子湖", 1991),    # 臺北市陽明山
    ("466950", "彭佳嶼", 1991),    # 基隆市離島
    ("467060", "蘇澳", 1991),      # 宜蘭縣
    ("467300", "東吉島", 1991),    # 澎湖縣離島
    ("467420", "永康", 1991),      # 臺南市
    ("467770", "梧棲", 1991),      # 臺中市海線
]
